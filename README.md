...
**Результат:**
![Приклад графіку функції](screenshots/Example2.jpg)
...
**Результат:**
![Приклад похідної](screenshots/Example2.jpg)

**Невизначений інтеграл:**
**Вхідні дані:** `x**2 + sin(x)`
**Результат:**
![Приклад невизначеного інтегралу](screenshots/Example2.jpg)

**Визначений інтеграл:**
**Вхідні дані:** `x**2` (вкажіть межі, наприклад від 0 до 2)
**Результат:**
![Приклад визначеного інтегралу](screenshots/Example2.jpg)
