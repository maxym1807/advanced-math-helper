...
**Результат:**
![Приклад похідної](screenshots/Example3.jpg)

**Невизначений інтеграл:**

**Вхідні дані:** `x**2 + sin(x)`
**Результат:**
![Приклад невизначеного інтегралу](screenshots/Example4.jpg)

**Визначений інтеграл:**

**Вхідні дані:** `x**2` (вкажіть межі, наприклад від 0 до 2)
**Результат:**
![Приклад визначеного інтегралу](screenshots/Example5.jpg)
